...
from astraretriver import InventorySimilarityTool
tools = [InventorySimilarityTool()]
...
conversational_memory = CassandraChatMessageHistory(
    session_id='inv-conversation-999',
...
system_message = SystemMessage(content="You are a eCommerce AI Assistant, a sophisticated eCommerce assistant, specialized in providing recommendations to customers on electronic products "
                                       "with specifications and price. With expert knowledge and precision, you are here to "
                                       "provide accurate information and solutions to product queries. When calling the tool, include as much detail as possible " 
...
# set header
st.header("Welcome to our ChatBot! You can speak to this bot")
